...
import com.master.spring.spring1proj1.res1.BinarySearchImpl;

/*
 * This annotation @ComponentScan has an attribute 'basePackages'
 * that takes array of strings representing packages to scan.
 */
@ComponentScan(basePackages = { "com.master.spring.spring1proj1.res1", "com.master.spring.spring1proj1.renamer" })
